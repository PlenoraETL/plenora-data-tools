...
pub static CATALOG: &[OperationDescriptor] = &[
    ...
    op!("table.dedup_advanced", Table, ManipolaCompat, Unary, Blocking, BoundaryOnly, None, None, &[], CanonicalOrder, PublicProtocol),
    op!("table.distinct", Table, ManipolaCompat, Unary, Blocking, BoundaryOnly, None, None, &[], CanonicalOrder, PublicProtocol),
    ...
    op!("table.flatten_json", Table, ManipolaCompat, Unary, Streaming, Cooperative, None, None, &[], DefinedOrder, PublicProtocol),
    ...
    op!("table.statistics", Table, ManipolaCompat, Unary, Blocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    ...
    op!("table.table_diff", Table, ManipolaCompat, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    ...
    op!("table.window_function", Table, ManipolaCompat, Unary, Blocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    op!("table.mask_data", Table, ManipolaCompat, Unary, Streaming, Cooperative, None, None, &[], DefinedOrder, PublicProtocol),
    ...
    op!("table.except", Table, Extension, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], CanonicalOrder, PublicProtocol),
    op!("table.explode", Table, Extension, Unary, Blocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    op!("table.intersect", Table, Extension, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], CanonicalOrder, PublicProtocol),
    op!("table.rolling_window", Table, Extension, Unary, Blocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    ...
    op!("table.union_distinct", Table, Extension, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], CanonicalOrder, PublicProtocol),
    ...
    op!("table.assert_foreign_key", Table, Extension, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
    op!("table.reconcile", Table, Extension, BinaryOrdered, BinaryBlocking, BoundaryOnly, None, None, &[], DefinedOrder, PublicProtocol),
