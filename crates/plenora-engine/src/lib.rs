...
//!
//! Fase 2B M1a/M1b aggiunge [`governor`] (architettura.md#memoria/architettura.md#determinismo): budget
...
//!
//! Fase 2B M2c aggiunge il wiring dello spill generalizzato (architettura.md#memoria):
